...
// You can change it
//-----------------------------------------
// #define PLUGIN_LOG_DIR "ultrahc_json_chat" // directory for logs in amxmodx/logs
...
public plugin_init() {
	...
	__cvars_list[_use_sql] = create_cvar("ultrahc_user_sql", "0", _, "[1/0] use sql to save chat", true, 0.0, true, 1.0);
